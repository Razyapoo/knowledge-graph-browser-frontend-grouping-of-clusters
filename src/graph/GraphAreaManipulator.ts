                    ...
                    if (this.classesToClusterTogether.length > 0) {
                        while (nodesToClusterByClass.length === 0 && classesToClusterTogetherID < this.classesToClusterTogether.length) {
                            nodesToClusterByParent.forEach(node => {
                                if ((node instanceof NodeGroup) && (this.isSubset(node.nocache_nonhierarchicalClassesOfNodes, this.classesToClusterTogether[classesToClusterTogetherID]) || this.isSubset(this.classesToClusterTogether[classesToClusterTogetherID], node.nocache_nonhierarchical_classesOfNodes))) {
